...
ApplicationWindow {
    ...
    property color bg: "#0a0f1d"
    property color sideBg: "#070b14"
    property color panel: "#101827"
    property color card: "#111c2e"
    property color card2: "#0d1626"
    property color fieldBg: "#0b1220"
    property color line: "#243244"
    property color lineStrong: "#334155"
    property color accent: "#38bdf8"
    property color accentSoft: "#0e7490"
    property color textMain: "#f8fafc"
    property color textSub: "#a7b4c7"
    property color textMuted: "#64748b"
    property color danger: "#fb7185"
    property color ok: "#22c55e"
    property int pagePad: 24
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                RowLayout { Layout.fillWidth: true; spacing: 8
                    Button { Layout.fillWidth: true; text: "中文"; highlighted: appController.language === "zh"; ToolTip.visible: hovered; ToolTip.text: "切换中文"; onClicked: appController.setLanguage("zh") }
                    Button { Layout.fillWidth: true; text: "EN"; highlighted: appController.language === "en"; ToolTip.visible: hovered; ToolTip.text: "Switch to English"; onClicked: appController.setLanguage("en") }
                }
                ...
                Card { cardHeight: 270; cardTitle: appController.language === "en" ? "Quick actions" : "快捷操作"; cardSubtitle: appController.language === "en" ? "Lightweight actions only. Heavy diagnostics stay in self-test/package scripts." : "这里只放轻量操作，避免仪表盘点击卡住。"
                    ColumnLayout { anchors.fill: parent; anchors.margins: 16; spacing: 12
                        ...
                        RowLayout { Layout.fillWidth: true; spacing: 10
                            Button { text: root.t("load_samples"); ToolTip.visible: hovered; ToolTip.text: "加载本地示例"; onClicked: { appController.loadMockArticles(); setDetail(text, appController.status) } }
                            Button { text: root.t("collect_now"); highlighted: true; ToolTip.visible: hovered; ToolTip.text: "按关键词立即采集"; onClicked: { appController.runCollection(dashKeyword.text); setDetail(text, appController.status) } }
                            Button { text: root.t("self_check"); ToolTip.visible: hovered; ToolTip.text: "查看自检入口说明，不在仪表盘同步跑重任务"; onClicked: setDetail(text, appController.language === "en" ? "Use run-with-log.bat or --self-test for full diagnostics." : "完整诊断请运行 run-with-log.bat 或 --self-test，避免界面卡住。") }
                        }
                    }
                }
            ...
            PageFrame { pageTitle: root.t("library_title"); pageGuide: root.guide("library")
                Card { cardHeight: 250; cardTitle: appController.language === "en" ? "Search and actions" : "搜索与操作"; cardSubtitle: appController.language === "en" ? "Clear labels and separated action buttons" : "输入和按钮分区显示，不挤在一行"
                    ColumnLayout { anchors.fill: parent; anchors.margins: 16; spacing: 12
                        ...
                        RowLayout { Layout.fillWidth: true; spacing: 10
                            Button { text: appController.language === "en" ? "Refresh" : "刷新"; ToolTip.visible: hovered; ToolTip.text: "刷新列表"; onClicked: root.libraryRows = appController.articleRows(search.text) }
                            Button { text: appController.language === "en" ? "Export MD" : "导出 MD"; ToolTip.visible: hovered; ToolTip.text: "导出本地内容 Markdown"; onClicked: appController.exportMarkdown("media-hit-articles.md") }
                            Button { text: appController.language === "en" ? "Export XML" : "导出 XML"; ToolTip.visible: hovered; ToolTip.text: "导出本地内容 XML"; onClicked: appController.exportXml("media-hit-articles.xml") }
                        }
                    }
                }
                ...
                Card { cardHeight: 680; cardTitle: appController.language === "en" ? "Request parameters" : "采集参数"; cardSubtitle: appController.language === "en" ? "Every field has a label, type, and help text" : "每个字段都有名称、类型和说明"
                    ColumnLayout { anchors.fill: parent; anchors.margins: 16; spacing: 14
                        GridLayout { Layout.fillWidth: true; columns: root.width > 1240 ? 2 : 1; columnSpacing: 18; rowSpacing: 14
                            FormText { id: hotKey; label: "key"; hint: appController.language === "en" ? "Secret key; blank uses local sample" : "密钥；留空使用本地示例"; password: true }
                            FormText { id: hotKeyword; label: "keyword"; hint: appController.language === "en" ? "Text keyword; blank means all" : "文本关键词；为空搜索全部"; text: "AI" }
                            FormCombo { label: "pub_type"; hint: appController.language === "en" ? "Content type enum" : "内容类型枚举"
                                ComboBox { id: hotPubType; anchors.fill: parent; textRole: "label"; valueRole: "value"; model: [{value:"0",label:"0 · 图文"},{value:"5",label:"5 · 纯视频"},{value:"7",label:"7 · 纯音乐"},{value:"8",label:"8 · 纯图片"},{value:"10",label:"10 · 纯文字"},{value:"11",label:"11 · 转载文章"}]; ToolTip.visible: hovered; ToolTip.text: "pub_type" }
                            }
                            FormCombo { label: "category"; hint: appController.language === "en" ? "Category enum 0-30" : "分类枚举 0-30"
                                ComboBox { id: hotCategory; anchors.fill: parent; textRole: "label"; valueRole: "value"; model: [{value:"0",label:"0 · 全部"},{value:"1",label:"1 · 国际"},{value:"2",label:"2 · 体育"},{value:"3",label:"3 · 娱乐"},{value:"4",label:"4 · 社会"},{value:"5",label:"5 · 财经"},{value:"6",label:"6 · 时事"},{value:"7",label:"7 · 科技"},{value:"8",label:"8 · 情感"},{value:"9",label:"9 · 汽车"},{value:"10",label:"10 · 教育"},{value:"11",label:"11 · 时尚"},{value:"12",label:"12 · 游戏"},{value:"13",label:"13 · 军事"},{value:"14",label:"14 · 旅游"},{value:"15",label:"15 · 美食"},{value:"16",label:"16 · 文化"},{value:"17",label:"17 · 健康"},{value:"18",label:"18 · 搞笑"},{value:"19",label:"19 · 家居"},{value:"20",label:"20 · 动漫"},{value:"21",label:"21 · 宠物"},{value:"22",label:"22 · 母婴"},{value:"23",label:"23 · 星座"},{value:"24",label:"24 · 历史"},{value:"25",label:"25 · 音乐"},{value:"26",label:"26 · 未分类"},{value:"27",label:"27 · 综合"},{value:"28",label:"28 · 职场"},{value:"29",label:"29 · 三农"},{value:"30",label:"30 · 养老"}]; ToolTip.visible: hovered; ToolTip.text: "category" }
                            }
                            FormSpin { id: hotPage; label: "page"; hint: appController.language === "en" ? "Positive page number" : "正整数页码"; fromValue: 1; toValue: 9999; currentValue: 1 }
                            FormCombo { label: appController.language === "en" ? "Date preset" : "日期预设"; hint: appController.language === "en" ? "Quickly fill start/end" : "快速填入起止日期"
                                RowLayout { anchors.fill: parent; spacing: 8
                                    ComboBox { id: datePreset; Layout.fillWidth: true; textRole: "label"; valueRole: "value"; model: [{value:"last_7_days",label:appController.language === "en" ? "Last 7 days" : "最近7天"},{value:"last_30_days",label:appController.language === "en" ? "Last 30 days" : "最近30天"},{value:"this_month",label:appController.language === "en" ? "This month" : "本月"},{value:"custom",label:appController.language === "en" ? "Custom" : "自定义"}]; ToolTip.visible: hovered; ToolTip.text: "date preset" }
                                    Button { text: appController.language === "en" ? "Apply" : "应用"; ToolTip.visible: hovered; ToolTip.text: "应用日期预设"; onClicked: { var r = appController.dateRangeForPreset(datePreset.currentValue); hotStart.text = r[0]; hotEnd.text = r[1] } }
                                }
                            }
                            DateField { id: hotStart; label: "start_time"; hint: appController.language === "en" ? "Start date" : "开始日期"; text: "2026-05-15" }
                            DateField { id: hotEnd; label: "end_time"; hint: appController.language === "en" ? "End date" : "截止日期"; text: "2026-05-17" }
                        }
                        RowLayout { Layout.fillWidth: true; spacing: 10
                            Button { text: root.t("preview_payload"); ToolTip.visible: hovered; ToolTip.text: "预览请求参数"; onClicked: payloadPreview.text = appController.hotTypicalPayloadPreview(hotKey.text, hotKeyword.text, hotPubType.currentValue, hotCategory.currentValue, hotPage.value, hotStart.text, hotEnd.text) }
                            ...
                            Button { text: appController.language === "en" ? "Open result table" : "打开结果表"; ToolTip.visible: hovered; ToolTip.text: "打开结果表页面"; onClicked: { refreshHotRows(); stack.currentIndex = 3 } }
                        }
                    }
                }
    ...
    component FormText: ColumnLayout {
        ...
        RowLayout { Layout.fillWidth: true; spacing: 8
            ...
            Button { id: show; visible: password; checkable: true; text: checked ? (appController.language === "en" ? "Hide" : "隐藏") : (appController.language === "en" ? "Show" : "显示"); ToolTip.visible: hovered; ToolTip.text: "显示或隐藏" }
        }
    ...
    component DateField: ColumnLayout {
        ...
        RowLayout { Layout.fillWidth: true; spacing: 8
            ...
            Button { text: appController.language === "en" ? "Pick" : "选择"; ToolTip.visible: hovered; ToolTip.text: "打开日期选择器"; onClicked: { var p = dateText.text.split("-"); yearBox.value = Number(p[0]); monthBox.value = Number(p[1]); dayBox.value = Number(p[2]); picker.open() } }
        }
        Label { text: hint; color: textMuted; font.pixelSize: 12; wrapMode: Text.WordWrap; Layout.fillWidth: true }
    ...
    component RowCard: Rectangle {
        ...
        height: 48
        color: hover.containsMouse ? "#172554" : card2
        radius: 12
        border.color: line
    ...
    component ResultPage: Rectangle {
        ...
        ColumnLayout { anchors.fill: parent; anchors.margins: pagePad; spacing: 12
            ...
            RowLayout { Layout.fillWidth: true; spacing: 10
                ...
                Button { text: appController.language === "en" ? "Refresh" : "刷新"; ToolTip.visible: hovered; ToolTip.text: "刷新解析结果"; onClicked: refreshHotRows() }
                Button { text: appController.language === "en" ? "Export..." : "导出..."; ToolTip.visible: hovered; ToolTip.text: "选择格式和路径"; onClicked: exportDialog.openForHotResults() }
            }
    ...
    component HeaderCell: Rectangle { property string text: ""; property int w: 120; width: w; height: 42; color: "#1e293b"; border.color: line; Label { anchors.centerIn: parent; width: parent.width - 12; text: parent.text; color: textMain; font.bold: true; horizontalAlignment: Text.AlignHCenter; elide: Text.ElideRight } }
    component Cell: Rectangle { property string text: ""; property int w: 120; property bool selected: false; width: w; height: 38; color: selected ? "#12375a" : fieldBg; border.color: line; Label { anchors.verticalCenter: parent.verticalCenter; anchors.left: parent.left; anchors.leftMargin: 8; width: parent.width - 16; text: parent.text; color: textMain; elide: Text.ElideRight } }
    component DataRow: Rectangle { property int rowIndex: 0; property string rowText: ""; width: 1562; height: 38; color: root.selectedHotRow === rowIndex ? "#12375a" : fieldBg; Row { anchors.fill: parent; Cell { text: String(rowIndex + 1); w: 52; selected: root.selectedHotRow === rowIndex } Cell { text: root.hotCell(rowText, 0); w: 340; selected: root.selectedHotRow === rowIndex } Cell { text: root.hotCell(rowText, 1); w: 170; selected: root.selectedHotRow === rowIndex } Cell { text: root.hotCell(rowText, 2); w: 130; selected: root.selectedHotRow === rowIndex } Cell { text: root.hotCell(rowText, 3); w: 90; selected: root.selectedHotRow === rowIndex } Cell { text: root.hotCell(rowText, 4); w: 110; selected: root.selectedHotRow === rowIndex } Cell { text: root.hotCell(rowText, 5); w: 110; selected: root.selectedHotRow === rowIndex } Cell { text: root.hotCell(rowText, 6); w: 110; selected: root.selectedHotRow === rowIndex } Cell { text: root.hotCell(rowText, 7); w: 110; selected: root.selectedHotRow === rowIndex } Cell { text: root.hotCell(rowText, 8); w: 340; selected: root.selectedHotRow === rowIndex } } MouseArea { anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor; onClicked: { root.selectedHotRow = rowIndex; setDetail(appController.language === "en" ? "Hot result" : "爆文结果", rowText) } } }
    ...
    component SimpleTextPage: PageFrame {
        ...
        Card { cardHeight: 620; cardTitle: titleText; cardSubtitle: guideText
            ColumnLayout { anchors.fill: parent; anchors.margins: 16; spacing: 12
                Button { text: buttonText; ToolTip.visible: hovered; ToolTip.text: buttonText; onClicked: action() }
    ...
    component PluginPage: PageFrame {
        ...
        Card { cardHeight: 150; cardTitle: appController.language === "en" ? "Plugin actions" : "插件操作"; cardSubtitle: appController.language === "en" ? "Separated controls" : "操作区单独分组"
            RowLayout { anchors.fill: parent; anchors.margins: 16; spacing: 10
                Button { text: appController.language === "en" ? "Refresh" : "刷新"; ToolTip.visible: hovered; ToolTip.text: "刷新插件"; onClicked: root.pluginRows = appController.pluginRows() }
                Button { text: appController.language === "en" ? "Analysis" : "插件分析"; ToolTip.visible: hovered; ToolTip.text: "运行分析"; onClicked: pluginReport.text = appController.pluginAnalysis() }
                Button { text: appController.language === "en" ? "Scan metadata" : "扫描元数据"; ToolTip.visible: hovered; ToolTip.text: "扫描元数据"; onClicked: pluginReport.text = appController.pluginScanReport("plugins") }
            }
        }
    ...
    component SettingsPage: PageFrame {
        ...
        Card { cardHeight: 440; cardTitle: appController.language === "en" ? "Collection task" : "采集任务"; cardSubtitle: appController.language === "en" ? "All controls have labels" : "所有控件都有说明"
            ColumnLayout { anchors.fill: parent; anchors.margins: 16; spacing: 14
                ...
                RowLayout { Layout.fillWidth: true; Button { text: appController.language === "en" ? "Save task" : "保存任务"; ToolTip.visible: hovered; ToolTip.text: "保存采集任务"; onClicked: { appController.createCollectionTask(taskName.text, taskKeyword.text, taskInterval.value, taskRuns.value); root.taskRows = appController.taskRows() } } Button { text: root.t("collect_now"); ToolTip.visible: hovered; ToolTip.text: "立即采集"; onClicked: appController.runCollection(taskKeyword.text) } }
            }
        }
        ...
        Card { cardHeight: 440; cardTitle: appController.language === "en" ? "Credentials and limits" : "密钥与限速"; cardSubtitle: appController.language === "en" ? "Local settings only" : "只保存本机设置"
            ColumnLayout { anchors.fill: parent; anchors.margins: 16; spacing: 14
                ...
                Button { text: appController.language === "en" ? "Save settings" : "保存设置"; ToolTip.visible: hovered; ToolTip.text: "保存设置"; onClicked: appController.saveSettings(apiKey.text, verify.text, defaultInterval.value, taskRuns.value, Number(qps.text)) }
            }
        }
    }
}
