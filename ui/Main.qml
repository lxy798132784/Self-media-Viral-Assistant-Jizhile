                ...
                ColumnLayout { anchors.fill: parent; anchors.margins: 24; spacing: 18
                    ...
                    Rectangle { Layout.fillWidth: true; Layout.fillHeight: true; color: panel; radius: 18; border.color: "#334155"
                        ColumnLayout { anchors.fill: parent; anchors.margins: 18; spacing: 16
                            ...
                            TextArea { Layout.fillWidth: true; Layout.fillHeight: true; readOnly: true; text: appController.language === "en" ? "Use the Hot Articles API page for the target Apifox endpoint. All documented request parameters have editable controls." : "重点使用公众号爆文 API 页面。Apifox 文档里的所有请求参数都有对应控件可修改。"; color: textMain; background: Rectangle { color: panel2; radius: 12 } }
                        }
                    }
                }
            }
                ...
                ColumnLayout { anchors.fill: parent; anchors.margins: 24; spacing: 14
                    ...
                    Rectangle { Layout.fillWidth: true; Layout.fillHeight: true; color: panel; radius: 18; border.color: "#334155"
                        ColumnLayout { anchors.fill: parent; anchors.margins: 18; spacing: 10
                            ...
                            ListView { Layout.fillWidth: true; Layout.preferredHeight: 125; model: appController.hotTypicalParameterRows(); delegate: Text { width: ListView.view.width; height: 25; text: modelData; color: textMain; elide: Text.ElideRight } }
