    ...
    RowLayout {
        ...
        StackLayout {
            ...
            PageFrame { pageTitle: root.t("hot_api_title"); pageGuide: root.guide("hot")
                Card { cardHeight: 1060; cardTitle: appController.language === "en" ? "Request parameters" : "采集参数"; cardSubtitle: appController.language === "en" ? "Set every control parameter before requesting data." : "关键词和所有控制参数都可修改，再发起请求。"
                    ColumnLayout { anchors.fill: parent; anchors.margins: 16; spacing: 14
                        GridLayout { Layout.fillWidth: true; columns: root.width > 1240 ? 2 : 1; columnSpacing: 18; rowSpacing: 14
                            ...
                            FormSpin { id: hotMinLike; label: appController.language === "en" ? "Min likes" : "最低点赞数"; hint: appController.language === "en" ? "Local like lower bound" : "本地点赞下限"; fromValue: 0; toValue: 100000000; currentValue: 0 }
                            FormSpin { id: hotMaxLike; label: appController.language === "en" ? "Max likes" : "最高点赞数"; hint: appController.language === "en" ? "Local like upper bound" : "本地点赞上限"; fromValue: 0; toValue: 100000000; currentValue: 100000000 }
                            FormSpin { id: hotMinWatch; label: appController.language === "en" ? "Min watches" : "最低在看数"; hint: appController.language === "en" ? "Local watch lower bound" : "本地在看下限"; fromValue: 0; toValue: 100000000; currentValue: 0 }
                            FormSpin { id: hotMaxWatch; label: appController.language === "en" ? "Max watches" : "最高在看数"; hint: appController.language === "en" ? "Local watch upper bound" : "本地在看上限"; fromValue: 0; toValue: 100000000; currentValue: 100000000 }
                            FormSpin { id: hotMinScore; label: appController.language === "en" ? "Min hot score" : "最低爆款分"; hint: appController.language === "en" ? "Local hot_score lower bound" : "本地爆款分下限"; fromValue: 0; toValue: 100000000; currentValue: 0 }
                            FormSpin { id: hotMaxScore; label: appController.language === "en" ? "Max hot score" : "最高爆款分"; hint: appController.language === "en" ? "Local hot_score upper bound" : "本地爆款分上限"; fromValue: 0; toValue: 100000000; currentValue: 100000000 }
                            FormSpin { id: hotMinAvgRead; label: appController.language === "en" ? "Min avg reads" : "最低均读"; hint: appController.language === "en" ? "Local avg read lower bound" : "本地均读下限"; fromValue: 0; toValue: 100000000; currentValue: 0 }
                            FormSpin { id: hotMaxAvgRead; label: appController.language === "en" ? "Max avg reads" : "最高均读"; hint: appController.language === "en" ? "Local avg read upper bound" : "本地均读上限"; fromValue: 0; toValue: 100000000; currentValue: 100000000 }
                            FormSpin { id: hotMinFans; label: appController.language === "en" ? "Min fans" : "最低粉丝数"; hint: appController.language === "en" ? "Local fans lower bound" : "本地粉丝数下限"; fromValue: 0; toValue: 100000000; currentValue: 0 }
                            FormSpin { id: hotMaxFans; label: appController.language === "en" ? "Max fans" : "最高粉丝数"; hint: appController.language === "en" ? "Local fans upper bound" : "本地粉丝数上限"; fromValue: 0; toValue: 100000000; currentValue: 100000000 }
                            FormSpin { id: hotMinPosition; label: appController.language === "en" ? "Min rank" : "最低排名"; hint: appController.language === "en" ? "Local rank lower bound" : "本地排名下限"; fromValue: 0; toValue: 100000000; currentValue: 0 }
                            FormSpin { id: hotMaxPosition; label: appController.language === "en" ? "Max rank" : "最高排名"; hint: appController.language === "en" ? "Local rank upper bound" : "本地排名上限"; fromValue: 0; toValue: 100000000; currentValue: 100000000 }
                            FormText { id: hotTitleInclude; label: appController.language === "en" ? "Title include" : "标题必须包含"; hint: appController.language === "en" ? "Blank means no include constraint" : "留空表示不限" }
                            FormText { id: hotTitleExclude; label: appController.language === "en" ? "Title exclude" : "标题排除词"; hint: appController.language === "en" ? "Reject titles containing this text" : "标题包含则排除" }
                            FormText { id: hotAccountInclude; label: appController.language === "en" ? "Account include" : "账号必须包含"; hint: appController.language === "en" ? "Blank means no account include constraint" : "留空表示不限" }
                            FormText { id: hotAccountExclude; label: appController.language === "en" ? "Account exclude" : "账号排除词"; hint: appController.language === "en" ? "Reject accounts containing this text" : "账号包含则排除" }
                            FormCombo { label: appController.language === "en" ? "Original filter" : "原创筛选"; hint: appController.language === "en" ? "Original / repost / any" : "原创、非原创或不限"
                                DarkCombo { id: hotOriginalMode; anchors.fill: parent; textRole: "label"; valueRole: "value"; model: [{value:"any",label:appController.language === "en" ? "Any" : "不限"},{value:"original",label:appController.language === "en" ? "Original only" : "只要原创"},{value:"non_original",label:appController.language === "en" ? "Non-original only" : "只要非原创/转载"}]; ToolTip.visible: hovered; ToolTip.text: "original filter" }
                            }
                        ...
                        RowLayout { Layout.fillWidth: true; spacing: 10
                            ...
                            AppButton { text: appController.language === "en" ? "Preview targeted plan" : "预览定向计划"; ToolTip.visible: hovered; ToolTip.text: appController.language === "en" ? "Preview all user-controlled filters and limits" : "预览关键词、分类、类型、时间和全部本地指标筛选"; onClicked: payloadPreview.text = appController.targetedHotTypicalAdvancedPreview(hotKeyword.text, hotPubType.currentValue, hotCategory.currentValue, hotStart.text, hotEnd.text, hotMinRead.value, hotMaxRead.value, hotMinLike.value, hotMaxLike.value, hotMinWatch.value, hotMaxWatch.value, hotMinScore.value, hotMaxScore.value, hotMinAvgRead.value, hotMaxAvgRead.value, hotMinFans.value, hotMaxFans.value, hotMinPosition.value, hotMaxPosition.value, hotTitleInclude.text, hotTitleExclude.text, hotAccountInclude.text, hotAccountExclude.text, hotOriginalMode.currentValue, hotTargetCount.value, hotMaxPages.value, hotMaxScan.value) }
                            ...
                            AppButton { text: appController.language === "en" ? "Run targeted collection" : "运行定向采集"; highlighted: true; ToolTip.visible: hovered; ToolTip.text: appController.language === "en" ? "Loop over user keywords/pages and locally filter all configured metrics" : "轮询用户关键词和页码，并按全部指标本地过滤"; onClicked: { payloadPreview.text = appController.targetedHotTypicalAdvancedPreview(hotKeyword.text, hotPubType.currentValue, hotCategory.currentValue, hotStart.text, hotEnd.text, hotMinRead.value, hotMaxRead.value, hotMinLike.value, hotMaxLike.value, hotMinWatch.value, hotMaxWatch.value, hotMinScore.value, hotMaxScore.value, hotMinAvgRead.value, hotMaxAvgRead.value, hotMinFans.value, hotMaxFans.value, hotMinPosition.value, hotMaxPosition.value, hotTitleInclude.text, hotTitleExclude.text, hotAccountInclude.text, hotAccountExclude.text, hotOriginalMode.currentValue, hotTargetCount.value, hotMaxPages.value, hotMaxScan.value); appController.runTargetedHotTypicalAdvancedCollection(hotKey.text, hotKeyword.text, hotPubType.currentValue, hotCategory.currentValue, hotStart.text, hotEnd.text, hotMinRead.value, hotMaxRead.value, hotMinLike.value, hotMaxLike.value, hotMinWatch.value, hotMaxWatch.value, hotMinScore.value, hotMaxScore.value, hotMinAvgRead.value, hotMaxAvgRead.value, hotMinFans.value, hotMaxFans.value, hotMinPosition.value, hotMaxPosition.value, hotTitleInclude.text, hotTitleExclude.text, hotAccountInclude.text, hotAccountExclude.text, hotOriginalMode.currentValue, hotTargetCount.value, hotMaxPages.value, hotMaxScan.value); refreshHotRows(); stack.currentIndex = 3 } }
