...
| API Catalog | Bundled Jizhilia API index, category filter, endpoint detail, endpoint collection. |
...
- UI: Qt6 and QML.
- Persistence: SQLite.
- API: Jizhilia endpoint payloads and a bundled local API catalog.
